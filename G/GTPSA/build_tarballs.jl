...
sources = [
    GitSource("https://github.com/mattsignorelli/gtpsa.git", "bd1d47a5b6ede5bf522618a5c7974139ee81b5eb")
]
...
build_tarballs(ARGS, name, version, sources, script, platforms, products, dependencies; julia_compat="1.6", preferred_gcc_version = v"11.4.0")
