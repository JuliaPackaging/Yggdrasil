...
products = [
    ...
    ExecutableProduct("gdal_create", :gdal_create_path),
    ExecutableProduct("gdal_footprint", :gdal_footprint_path),
    ...
    ExecutableProduct("gdal_viewshed", :gdal_viewshed_path),
    ...
    ExecutableProduct("gdalenhance", :gdalenhance_path),
    ...
    ExecutableProduct("gdalmdiminfo", :gdalmdiminfo_path),
    ExecutableProduct("gdalmdimtranslate", :gdalmdimtranslate_path),
    ...
    ExecutableProduct("gnmanalyse", :gnmanalyse_path),
    ExecutableProduct("gnmmanage", :gnmmanage_path),
    ...
    ExecutableProduct("sozip", :sozip_path),
]
