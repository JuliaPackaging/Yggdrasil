...
sources = [
    ...
    "3ca89b546dc726a159e58d4f06e06349930ca4ac"),
...
build_tarballs(ARGS, name, version, sources, script, platforms, products, dependencies; julia_compat="1.7", preferred_gcc_version = v"11")
