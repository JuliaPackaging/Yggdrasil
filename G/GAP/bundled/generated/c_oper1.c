 ...
 Obj  a_mutflag )
{
 ...
 if ( t_1 ) {
  ...
  if ( t_1 ) {
   ...
   t_7 = NewFunctionBody();
   SET_STARTLINE_BODY(t_7, 732);
   SET_ENDLINE_BODY(t_7, 750);
 ...
 Obj  a_keytest )
{
 ...
 if ( t_1 ) {
  ...
  t_2 = NewFunctionBody();
  SET_STARTLINE_BODY(t_2, 929);
  SET_ENDLINE_BODY(t_2, 933);
 ...
 SET_ENVI_FUNC( t_6, STATE(CurrLVars) );
 t_7 = NewFunctionBody();
 SET_STARTLINE_BODY(t_7, 1005);
 SET_ENDLINE_BODY(t_7, 1013);
 SET_FILENAME_BODY(t_7, FileName);
 SET_BODY_FUNC(t_6, t_7);
 if ( TNUM_OBJ( t_1 ) == T_FUNCTION ) {
  CALL_6ARGS( t_1, t_2, t_3, t_4, t_5, INTOBJ_INT(0), t_6 );
 ...
 SET_ENVI_FUNC( t_6, STATE(CurrLVars) );
 t_7 = NewFunctionBody();
 SET_STARTLINE_BODY(t_7, 1022);
 SET_ENDLINE_BODY(t_7, 1035);
 SET_FILENAME_BODY(t_7, FileName);
 SET_BODY_FUNC(t_6, t_7);
 if ( TNUM_OBJ( t_1 ) == T_FUNCTION ) {
  CALL_6ARGS( t_1, t_2, t_3, t_4, t_5, INTOBJ_INT(0), t_6 );
 ...
 Obj  a_arg )
{
 ...
 t_5 = NewFunctionBody();
 SET_STARTLINE_BODY(t_5, 1101);
 SET_ENDLINE_BODY(t_5, 1117);
 ...
 Obj  self )
{
 ...
 t_3 = NewFunctionBody();
 SET_STARTLINE_BODY(t_3, 690);
 SET_ENDLINE_BODY(t_3, 754);
 ...
 SET_ENVI_FUNC( t_2, STATE(CurrLVars) );
 t_3 = NewFunctionBody();
 SET_STARTLINE_BODY(t_3, 757);
 SET_ENDLINE_BODY(t_3, 763);
 SET_FILENAME_BODY(t_3, FileName);
 SET_BODY_FUNC(t_2, t_3);
 if ( TNUM_OBJ( t_1 ) == T_FUNCTION ) {
  CALL_1ARGS( t_1, t_2 );
 ...
 SET_ENVI_FUNC( t_3, STATE(CurrLVars) );
 t_4 = NewFunctionBody();
 SET_STARTLINE_BODY(t_4, 776);
 SET_ENDLINE_BODY(t_4, 800);
 SET_FILENAME_BODY(t_4, FileName);
 SET_BODY_FUNC(t_3, t_4);
 if ( TNUM_OBJ( t_1 ) == T_FUNCTION ) {
  CALL_2ARGS( t_1, t_2, t_3 );
 ...
 SET_ENVI_FUNC( t_3, STATE(CurrLVars) );
 t_4 = NewFunctionBody();
 SET_STARTLINE_BODY(t_4, 925);
 SET_ENDLINE_BODY(t_4, 1036);
 SET_FILENAME_BODY(t_4, FileName);
 SET_BODY_FUNC(t_3, t_4);
 if ( TNUM_OBJ( t_1 ) == T_FUNCTION ) {
  CALL_2ARGS( t_1, t_2, t_3 );
 ...
 SET_ENVI_FUNC( t_3, STATE(CurrLVars) );
 t_4 = NewFunctionBody();
 SET_STARTLINE_BODY(t_4, 1071);
 SET_ENDLINE_BODY(t_4, 1118);
 SET_FILENAME_BODY(t_4, FileName);
 SET_BODY_FUNC(t_3, t_4);
 if ( TNUM_OBJ( t_1 ) == T_FUNCTION ) {
  CALL_2ARGS( t_1, t_2, t_3 );
 ...
 SET_ENVI_FUNC( t_1, STATE(CurrLVars) );
 t_2 = NewFunctionBody();
 SET_STARTLINE_BODY(t_2, 1134);
 SET_ENDLINE_BODY(t_2, 1134);
 SET_FILENAME_BODY(t_2, FileName);
 SET_BODY_FUNC(t_1, t_2);
