...
#
name = "Singular"
upstream_version = v"4.3.2-2" # 4.3.2p2 + saturate
version_offset = v"0.3.1"
...
sources = [
    GitSource("https://github.com/Singular/Singular.git", "5d369c3cbad1a1bf2d5c856a48fb8a30b51cec3b"),
