...
sources = [
    GitSource("https://github.com/Singular/Singular.git", "30799bcc01792cd7474adb1607b1fd7253558c99"),
...
dependencies = [
    ...
    Dependency(PackageSpec(name="FLINT_jll"), compat = "~301.500.000"),
