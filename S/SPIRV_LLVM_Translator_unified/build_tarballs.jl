...
sources = Dict(
    v"11.0.1" => [GitSource(repo, "caa4038025861069adf857be8a5214e6857ff182")],
    v"12.0.1" => [GitSource(repo, "3ed66fc7524d648dec5a71c5e09985d5aff5bd99")],
    v"13.0.1" => [GitSource(repo, "776d9041e3baf120222e88842a9d441218a3f791")]
)
