...
if [[ ${target} == aarch64-apple-* ]]; then opath="kdb/m64arm/c.o"; CC="clang"; extraflags="-arch arm64 -arch x86_64 -bundle -undefined dynamic_lookup"; fi
if [[ ${target} == x86_64-apple-* ]]; then opath="kdb/m64/c.o"; CC="clang"; extraflags="-arch arm64 -arch x86_64 -bundle -undefined dynamic_lookup"; fi
