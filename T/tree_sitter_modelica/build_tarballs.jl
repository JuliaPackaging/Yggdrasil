...
sources = [
    GitSource(
        "https://github.com/modelicahub/tree-sitter-modelica.git",
        "cf20fb1e68401d1c18825b82802101b3ad1d3f3b"
    ),
...
products = [
    LibraryProduct("libtreesitter_modelica", :libtreesitter_modelica)
]
