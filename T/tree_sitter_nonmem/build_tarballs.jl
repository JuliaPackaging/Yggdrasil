...
name = "tree_sitter_nonmem"
version = v"0.1.0"

# Collection of sources required to complete build
sources = [
    GitSource(
        "https://github.com/MichaelHatherly/tree-sitter-nonmem.git",
        "ba573f5431249af822823ebfb995fef53cd64fa9"
    ),
...
products = [
    LibraryProduct("libtreesitter_nonmem", :libtreesitter_nonmem),
]
