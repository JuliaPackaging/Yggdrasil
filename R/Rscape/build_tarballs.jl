...
sources = [
    ArchiveSource("http://rivaslab.org/software/rscape/rscape_v$(file_version_str).tar.gz",
                  "b4d76d7e4d875564ba5b97c9e96a9a1ef2c1fd7a5ad390850b04fd5eb7efc8b9"),
    DirectorySource("./bundled")
]

# Notes
# - so that Rscape can find all necessary files at runtime, set the env vars RSCAPE_{HOME,BIN,SHARE}
#   import Rscape_jll
#   d = Rscape_jll.artifact_dir
#   ENV["RSCAPE_HOME"] = d
#   ENV["RSCAPE_BIN"] = joinpath(d, "bin")
#   ENV["RSCAPE_SHARE"] = joinpath(d, "share")
# - R-scape optionally uses gnuplot at runtime
