const ROCM_GIT = "https://github.com/ROCm-Developer-Tools/rocprofiler.git"
const ROCM_TAGS = Dict(
    ...
    v"5.4.4" => "74ecd34d80a743a7ee7eda7e12b2cc187e04d0a3",
)
...
function configure_build(version)
    ...
    cd ${WORKSPACE}/srcdir/rocprofiler*/
    ...
    make -j${nproc}
    make install
    install_license ${WORKSPACE}/srcdir/rocprofiler*/LICENSE.txt
    """
    sources = [
    ...
    dependencies = Any[
        ...
        Dependency("roctracer_jll", compat=string(version)),
    ]
    #if version >= v"5.4.4"
