...
products = [
    ...
    LibraryProduct("libXrdFfs-5", :libXrdFfs),
    LibraryProduct("libXrdCryptoLite-5", :libXrdCryptoLite),
    LibraryProduct("libXrdSsiShMap-5", :libXrdSsiShMap),
