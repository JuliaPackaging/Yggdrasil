...
make
mkdir ${prefix}/quest
mkdir ${prefix}/quest/include
mkdir ${prefix}/quest/lib
cp $WORKSPACE/srcdir/QuEST-3.5.0/QuEST/include/* ${prefix}/quest/include/
cp $WORKSPACE/srcdir/QuEST-3.5.0/build/QuEST/libQuEST.so ${prefix}/quest/lib/
exit
"""
...
products = [
    LibraryProduct("libQuEST", :libquest, "quest/lib")
]
