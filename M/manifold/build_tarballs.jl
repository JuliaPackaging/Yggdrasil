...
cmake .. -DCMAKE_INSTALL_PREFIX=$prefix -DCMAKE_TOOLCHAIN_FILE=${CMAKE_TARGET_TOOLCHAIN} -DCMAKE_BUILD_TYPE=Release -DMANIFOLD_PAR=NONE -DMANIFOLD_TEST=OFF -DBUILD_TEST_CGAL=OFF -DMANIFOLD_PYBIND=OFF -DMANIFOLD_JSBIND=OFF -DMANIFOLD_EXPORT=OFF -DBUILD_SHARED_LIBS=ON
