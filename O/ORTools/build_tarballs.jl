...
install -Dvm 644 ortools/bop/bop_parameters.proto ${includedir}/operations_research/bop/bop_parameters.proto
install -Dvm 644 ortools/constraint_solver/assignment.proto ${includedir}/operations_research/assignment.proto
install -Dvm 644 ortools/constraint_solver/demon_profiler.proto ${includedir}/operations_research/demon_profiler.proto
install -Dvm 644 ortools/constraint_solver/search_limit.proto ${includedir}/operations_research/search_limit.proto
install -Dvm 644 ortools/constraint_solver/search_stats.proto ${includedir}/operations_research/search_stats.proto
install -Dvm 644 ortools/constraint_solver/solver_parameters.proto ${includedir}/operations_research/solver_parameters.proto
install -Dvm 644 ortools/constraint_solver/routing_enums.proto ${includedir}/operations_research/routing_enums.proto
install -Dvm 644 ortools/constraint_solver/routing_parameters.proto ${includedir}/operations_research/routing_parameters.proto
install -Dvm 644 ortools/glop/parameters.proto ${includedir}/operations_research/glop/parameters.proto
install -Dvm 644 ortools/graph/flow_problem.proto ${includedir}/operations_research/flow_problem.proto
install -Dvm 644 ortools/gscip/gscip.proto ${includedir}/operations_research/gscip.proto
install -Dvm 644 ortools/linear_solver/linear_solver.proto ${includedir}/operations_research/linear_solver.proto
install -Dvm 644 ortools/math_opt/callback.proto ${includedir}/operations_research/math_opt/callback.proto
install -Dvm 644 ortools/math_opt/infeasible_subsystem.proto ${includedir}/operations_research/math_opt/infeasible_subsystem.proto
install -Dvm 644 ortools/math_opt/model.proto ${includedir}/operations_research/math_opt/model.proto
install -Dvm 644 ortools/math_opt/model_parameters.proto ${includedir}/operations_research/math_opt/model_parameters.proto
install -Dvm 644 ortools/math_opt/model_update.proto ${includedir}/operations_research/math_opt/model_update.proto
install -Dvm 644 ortools/math_opt/result.proto ${includedir}/operations_research/math_opt/result.proto
install -Dvm 644 ortools/math_opt/solution.proto ${includedir}/operations_research/math_opt/solution.proto
install -Dvm 644 ortools/math_opt/parameters.proto ${includedir}/operations_research/math_opt/parameters.proto
install -Dvm 644 ortools/math_opt/solvers/glpk.proto ${includedir}/operations_research/math_opt/solvers/glpk.proto
install -Dvm 644 ortools/math_opt/solvers/gurobi.proto ${includedir}/operations_research/math_opt/solvers/gurobi.proto
install -Dvm 644 ortools/math_opt/solvers/highs.proto ${includedir}/operations_research/math_opt/solvers/highs.proto
install -Dvm 644 ortools/math_opt/sparse_containers.proto ${includedir}/operations_research/math_opt/sparse_containers.proto
install -Dvm 644 ortools/packing/multiple_dimensions_bin_packing.proto ${includedir}/operations_research/packing/multiple_dimensions_bin_packing.proto
install -Dvm 644 ortools/packing/vector_bin_packing.proto ${includedir}/operations_research/packing/vbp/vector_bin_packing.proto
install -Dvm 644 ortools/pdlp/solve_log.proto ${includedir}/operations_research/pdlp/solve_log.proto
install -Dvm 644 ortools/pdlp/solvers.proto ${includedir}/operations_research/pdlp/solvers.proto
install -Dvm 644 ortools/sat/cp_model.proto ${includedir}/operations_research/sat/cp_model.proto
install -Dvm 644 ortools/sat/sat_parameters.proto ${includedir}/operations_research/sat/sat_parameters.proto
install -Dvm 644 ortools/sat/boolean_problem.proto ${includedir}/operations_research/sat/boolean_problem.proto
install -Dvm 644 ortools/util/optional_boolean.proto ${includedir}/operations_research/optional_boolean.proto
install -Dvm 644 ortools/scheduling/course_scheduling.proto ${includedir}/operations_research/course_scheduling.proto
install -Dvm 644 ortools/scheduling/rcpsp.proto ${includedir}/operations_research/scheduling/rcpsp/rcpsp.proto
install -Dvm 644 ortools/scheduling/jobshop_scheduling.proto ${includedir}/operations_research/scheduling/jssp/jobshop_scheduling.proto
"""
