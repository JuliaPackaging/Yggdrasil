...
sources = [
    ...
    GitSource("https://github.com/JuliaImages/OpenCV.jl.git", "f042ff1b417f5f528cc7adf713dfedecfdf458fd"),  # OpenCV.jl#80 (macOS C++17 fix, rebased on master); re-pin to merge commit before registering
