...
data = [
    ...
    (; filename = "bun-linux-x64-musl.zip", sha = "68a154ff1be96851b4d1a87cc5197f027ef80ab79afa3d4587150fae5c34c36e", target = "x86_64-linux-musl", platform = Platform("x86_64", "linux"; libc = "musl")),
    (; filename = "bun-linux-aarch64-musl.zip", sha = "54592fd0237e3ec91a2933dff015e15a78989d97234042e7d5334a4c0ad50603", target = "aarch64-linux-musl", platform = Platform("aarch64", "linux"; libc = "musl")),
