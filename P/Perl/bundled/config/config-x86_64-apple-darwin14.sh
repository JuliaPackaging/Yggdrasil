...
ld='cc'
ld_can_script='undef'
lddlflags=' -mmacosx-version-min=10.8 -dynamiclib -undefined dynamic_lookup -fstack-protector-strong -L/workspace/destdir/lib -Wl,-rpath,/workspace/destdir/lib --sysroot=/opt/x86_64-apple-darwin14/x86_64-apple-darwin14/sys-root'
