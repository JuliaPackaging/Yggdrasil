...
config_args='-des -Dcc=cc -Dprefix=/workspace/destdir -Duserelocatableinc -Duseshrplib -Dsysroot=/opt/x86_64-unknown-freebsd12.2/x86_64-unknown-freebsd12.2/sys-root -Dccflags=-DPERL_FPU_INIT -fno-strict-aliasing -pipe -fstack-protector-strong -I/workspace/destdir/include -Dldflags=-L/workspace/destdir/lib -Dlddlflags=-shared -L/workspace/destdir/lib -Dusecrosscompile -Dtargethost=localhost -Dtargetarch=x86_64-unknown-freebsd12.2 -Dhostperl=/workspace/srcdir/perl-5.34.0/host/miniperl -Dhostgenerate=/workspace/srcdir/perl-5.34.0/host/generate_uudmap -Dtargetuser=root -Dtargetdir=/root/tmpdir -Dtargetport=2222 -Dusenm=false -Dosname=freebsd -Dhintfile=freebsd_11'
config_argc=20
config_arg1='-des'
config_arg2='-Dcc=cc'
...
lddlflags='-shared -L/workspace/destdir/lib --sysroot=/opt/x86_64-unknown-freebsd12.2/x86_64-unknown-freebsd12.2/sys-root -fstack-protector-strong'
