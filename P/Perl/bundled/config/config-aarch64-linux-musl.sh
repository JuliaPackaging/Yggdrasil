...
# Package name      : perl5
# Source directory  : .
# Configuration time: Thu Nov 18 15:01:36 UTC 2021
# Configured by     : root
# Target system     : linux earth 5.15.3-gentoo #1 juliaos smp preempt wed feb 13 00:49:00 utc 2013 aarch64 gnulinux 

: Configure command line arguments.
config_arg0='./Configure'
config_args='-des -Duserelocatableinc -Duseshrplib -Dusecrosscompile -Dsysroot=/opt/aarch64-linux-musl/aarch64-linux-musl/sys-root -Dtargethost=dummy -Dprefix=/workspace/destdir -Dhostperl=/workspace/srcdir/perl-5.34.1/host/miniperl -Dhostgenerate=/workspace/srcdir/perl-5.34.1/host/generate_uudmap -Dtargetrun=bb -Dtargetto=cp -Dccflags=-I/workspace/destdir/include -Dldflags=-L/workspace/destdir/lib -Dlddlflags=-shared -L/workspace/destdir/lib -Dtargetarch=aarch64-linux-musl -Dlibs=-lpthread -lcrypt -ldl -lm -lutil -lc'
config_argc=16
config_arg1='-des'
config_arg2='-Duserelocatableinc'
config_arg3='-Duseshrplib'
config_arg4='-Dusecrosscompile'
config_arg5='-Dsysroot=/opt/aarch64-linux-musl/aarch64-linux-musl/sys-root'
...
config_arg15='-Dtargetarch=aarch64-linux-musl'
...
ar='ar'
archlib='.../../lib/perl5/5.34.1/linux-musl'
archlibexp='.../../lib/perl5/5.34.1/linux-musl'
archname64=''
archname='linux-musl'
archobjs=''
asctime_r_proto='0'
...
cat='cat'
cc='cc'
cccdlflags='-fPIC --sysroot=/opt/aarch64-linux-musl/aarch64-linux-musl/sys-root'
ccdlflags='-Wl,-E -Wl,-rpath,\$$ORIGIN/../lib/perl5/5.34.1/linux-musl/CORE'
...
cf_time='Thu Nov 18 15:01:36 UTC 2021'
charbits='8'
charsize='1'
chgrp=''
chmod='chmod'
...
full_ar='/opt/bin/aarch64-linux-musl-libgfortran4-cxx11/ar'
full_csh='csh'
full_sed='/bin/sed'
gccansipedantic=''
gccosandvers=''
...
gidsize='4'
gidtype='gid_t'
glibpth=' /opt/aarch64-linux-musl/aarch64-linux-musl/sys-root/usr/shlib /opt/aarch64-linux-musl/aarch64-linux-musl/sys-root/lib /opt/aarch64-linux-musl/aarch64-linux-musl/sys-root/usr/lib /opt/aarch64-linux-musl/aarch64-linux-musl/sys-root/usr/lib/386 /opt/aarch64-linux-musl/aarch64-linux-musl/sys-root/lib/386 /opt/aarch64-linux-musl/aarch64-linux-musl/sys-root/usr/ccs/lib /opt/aarch64-linux-musl/aarch64-linux-musl/sys-root/usr/ucblib /opt/aarch64-linux-musl/aarch64-linux-musl/sys-root/usr/local/lib'
gmake='gmake'
gmtime_r_proto='0'
gnulibc_version=''
grep='grep'
...
incpath=''
incpth='/opt/aarch64-linux-musl/aarch64-linux-musl/include /opt/aarch64-linux-musl/lib/gcc/aarch64-linux-musl/7.1.0/include /workspace/aarch64-linux-musl-libgfortran4-cxx11/destdir/include /opt/aarch64-linux-musl/aarch64-linux-musl/sys-root/usr/include'
inews=''
initialinstalllocation='/workspace/destdir/bin'
installarchlib='.../../lib/perl5/5.34.1/linux-musl'
...
installscript='.../'
installsitearch='.../../lib/perl5/site_perl/5.34.1/linux-musl'
installsitebin='.../../bin'
installsitehtml1dir=''
installsitehtml3dir=''
...
lddlflags='-shared -L/workspace/destdir/lib --sysroot=/opt/aarch64-linux-musl/aarch64-linux-musl/sys-root -fstack-protector-strong'
ldflags='-L/workspace/destdir/lib -fstack-protector-strong'
ldflags_uselargefiles=''
ldlibpthname='LD_LIBRARY_PATH'
less='less'
lib_ext='.a'
libc='/opt/aarch64-linux-musl/bin/../aarch64-linux-musl/sys-root/usr/lib/libc.so'
libperl='libperl.so'
libpth='/opt/aarch64-linux-musl/aarch64-linux-musl/lib /workspace/aarch64-linux-musl-libgfortran4-cxx11/destdir/lib /opt/aarch64-linux-musl/aarch64-linux-musl/sys-root/usr/lib /opt/aarch64-linux-musl/aarch64-linux-musl/sys-root/lib'
libs='-lpthread -lcrypt -ldl -lm -lutil -lc'
libsdirs=''
libsfiles=''
libsfound=''
libspath=' /opt/aarch64-linux-musl/aarch64-linux-musl/lib /workspace/aarch64-linux-musl-libgfortran4-cxx11/destdir/lib /opt/aarch64-linux-musl/aarch64-linux-musl/sys-root/usr/lib /opt/aarch64-linux-musl/aarch64-linux-musl/sys-root/lib'
...
mydomain='.nonet'
myhostname='earth'
myuname='linux earth 5.15.3-gentoo #1 juliaos smp preempt wed feb 13 00:49:00 utc 2013 aarch64 gnulinux '
n='-n'
need_va_copy='undef'
...
phostname='hostname'
pidtype='pid_t'
plibpth='/opt/aarch64-linux-musl/bin/../aarch64-linux-musl/sys-root/lib/aarch64-linux-musl/7.1.0 /opt/aarch64-linux-musl/bin/../aarch64-linux-musl/sys-root/lib/../lib64 /opt/aarch64-linux-musl/bin/../aarch64-linux-musl/sys-root/usr/lib/aarch64-linux-musl/7.1.0 /opt/aarch64-linux-musl/bin/../aarch64-linux-musl/sys-root/usr/lib/../lib64 /opt/aarch64-linux-musl/bin/../aarch64-linux-musl/sys-root/lib /opt/aarch64-linux-musl/bin/../aarch64-linux-musl/sys-root/usr/lib'
pmake=''
pr=''
prefix='.../..'
prefixexp='.../..'
...
sig_size='68'
signal_t='void'
sitearch='.../../lib/perl5/site_perl/5.34.1/linux-musl'
sitearchexp='.../../lib/perl5/site_perl/5.34.1/linux-musl'
sitebin='.../../bin'
sitebinexp='.../../bin'
sitehtml1dir=''
sitehtml1direxp=''
...
sysroot='/opt/aarch64-linux-musl/aarch64-linux-musl/sys-root'
tail=''
tar=''
...
tee=''
test='test'
timeincl='/opt/aarch64-linux-musl/aarch64-linux-musl/sys-root/usr/include/sys/time.h '
timetype='time_t'
tmpnam_r_proto='0'
...
usevfork='false'
usrinc='/opt/aarch64-linux-musl/aarch64-linux-musl/sys-root/usr/include'
uuname=''
uvXUformat='"lX"'
uvoformat='"lo"'
uvsize='8'
...
versiononly='undef'
vi=''
xlibpth=' /opt/aarch64-linux-musl/aarch64-linux-musl/sys-root/usr/lib/386 /opt/aarch64-linux-musl/aarch64-linux-musl/sys-root/lib/386'
yacc='yacc'
yaccflags=''
zcat=''
zip='zip'
