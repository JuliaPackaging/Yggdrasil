...
config_args='-des -Duserelocatableinc -Duseshrplib -Dusecrosscompile -Dsysroot=/opt/aarch64-linux-musl/aarch64-linux-musl/sys-root -Dtargethost=dummy -Dprefix=/workspace/destdir -Dhostperl=/workspace/srcdir/perl-5.34.0/host/miniperl -Dhostgenerate=/workspace/srcdir/perl-5.34.0/host/generate_uudmap -Dtargetrun=bb -Dtargetto=cp -Dccflags=-I/workspace/destdir/include -Dldflags=-L/workspace/destdir/lib -Wl,-rpath,/workspace/destdir/lib -Dlddlflags=-shared -L/workspace/destdir/lib -Wl,-rpath,/workspace/destdir/lib -Dtargetarch=aarch64-linux-musl -Dlibs=-lpthread -lcrypt -ldl -lm -lutil -lc'
config_argc=16
config_arg1='-des'
...
lddlflags='-shared -L/workspace/destdir/lib -Wl,-rpath,/workspace/destdir/lib --sysroot=/opt/aarch64-linux-musl/aarch64-linux-musl/sys-root -fstack-protector-strong'
