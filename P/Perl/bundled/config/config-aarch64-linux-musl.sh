...
config_args='-des -Duserelocatableinc -Duseshrplib -Dusecrosscompile -Dsysroot=/opt/aarch64-linux-musl/aarch64-linux-musl/sys-root -Dtargethost=dummy -Dprefix=/workspace/destdir -Dhostperl=/workspace/srcdir/perl-5.34.0/host/miniperl -Dhostgenerate=/workspace/srcdir/perl-5.34.0/host/generate_uudmap -Dtargetrun=bb -Dtargetto=cp -Dccflags=-I/workspace/destdir/include -Dldflags=-L/workspace/destdir/lib -Dlddlflags=-shared -L/workspace/destdir/lib -Dtargetarch=aarch64-linux-musl -Dlibs=-lpthread -lcrypt -ldl -lm -lutil -lc'
config_argc=16
config_arg1='-des'
...
ar='ar'
archlib='.../../lib/perl5/5.34.0/linux-musl'
archlibexp='.../../lib/perl5/5.34.0/linux-musl'
archname64=''
archname='linux-musl'
archobjs=''
asctime_r_proto='0'
...
ccdlflags='-Wl,-E -Wl,-rpath,\$$ORIGIN/../lib/perl5/5.34.0/linux-musl/CORE'
...
installarchlib='.../../lib/perl5/5.34.0/linux-musl'
...
installscript='.../'
installsitearch='.../../lib/perl5/site_perl/5.34.0/linux-musl'
installsitebin='.../../bin'
installsitehtml1dir=''
installsitehtml3dir=''
...
sig_size='68'
signal_t='void'
sitearch='.../../lib/perl5/site_perl/5.34.0/linux-musl'
sitearchexp='.../../lib/perl5/site_perl/5.34.0/linux-musl'
sitebin='.../../bin'
sitebinexp='.../../bin'
sitehtml1dir=''
sitehtml1direxp=''
