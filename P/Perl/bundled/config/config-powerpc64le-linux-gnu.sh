...
# Package name      : perl5
# Source directory  : .
# Configuration time: Thu Nov 18 15:18:30 UTC 2021
# Configured by     : root
# Target system     : linux earth 5.15.3-gentoo #1 juliaos smp preempt wed feb 13 00:49:00 utc 2013 ppc64le gnulinux 

: Configure command line arguments.
config_arg0='./Configure'
config_args='-des -Duserelocatableinc -Duseshrplib -Dusecrosscompile -Dsysroot=/opt/powerpc64le-linux-gnu/powerpc64le-linux-gnu/sys-root -Dtargethost=dummy -Dprefix=/workspace/destdir -Dhostperl=/workspace/srcdir/perl-5.34.1/host/miniperl -Dhostgenerate=/workspace/srcdir/perl-5.34.1/host/generate_uudmap -Dtargetrun=bb -Dtargetto=cp -Dccflags=-I/workspace/destdir/include -Dldflags=-L/workspace/destdir/lib -Dlddlflags=-shared -L/workspace/destdir/lib -Dtargetarch=powerpc64le-linux-gnu -Dlibs=-lpthread -ldl -lm -lutil -lc'
config_argc=16
config_arg1='-des'
config_arg2='-Duserelocatableinc'
config_arg3='-Duseshrplib'
config_arg4='-Dusecrosscompile'
config_arg5='-Dsysroot=/opt/powerpc64le-linux-gnu/powerpc64le-linux-gnu/sys-root'
...
config_arg15='-Dtargetarch=powerpc64le-linux-gnu'
config_arg16='-Dlibs=-lpthread -ldl -lm -lutil -lc'
...
ar='ar'
archlib='.../../lib/perl5/5.34.1/linux-gnu'
archlibexp='.../../lib/perl5/5.34.1/linux-gnu'
archname64=''
archname='linux-gnu'
archobjs=''
asctime_r_proto='0'
...
cat='cat'
cc='cc'
cccdlflags='-fPIC --sysroot=/opt/powerpc64le-linux-gnu/powerpc64le-linux-gnu/sys-root'
ccdlflags='-Wl,-E -Wl,-rpath,\$$ORIGIN/../lib/perl5/5.34.1/linux-gnu/CORE'
...
ccname='gcc'
ccsymbols='=1 system=linux system=posix system=unix'
ccversion=''
cf_by='root'
cf_email='root@earth.nonet'
cf_time='Thu Nov 18 15:18:30 UTC 2021'
charbits='8'
charsize='1'
chgrp=''
chmod='chmod'
...
full_ar='/opt/bin/powerpc64le-linux-gnu-libgfortran4-cxx11/ar'
full_csh='csh'
full_sed='/bin/sed'
gccansipedantic=''
gccosandvers=''
...
gidsize='4'
gidtype='gid_t'
glibpth=' /opt/powerpc64le-linux-gnu/powerpc64le-linux-gnu/sys-root/usr/shlib /opt/powerpc64le-linux-gnu/powerpc64le-linux-gnu/sys-root/lib /opt/powerpc64le-linux-gnu/powerpc64le-linux-gnu/sys-root/usr/lib /opt/powerpc64le-linux-gnu/powerpc64le-linux-gnu/sys-root/usr/lib/386 /opt/powerpc64le-linux-gnu/powerpc64le-linux-gnu/sys-root/lib/386 /opt/powerpc64le-linux-gnu/powerpc64le-linux-gnu/sys-root/usr/ccs/lib /opt/powerpc64le-linux-gnu/powerpc64le-linux-gnu/sys-root/usr/ucblib /opt/powerpc64le-linux-gnu/powerpc64le-linux-gnu/sys-root/usr/local/lib'
gmake='gmake'
gmtime_r_proto='0'
...
incpath=''
incpth='/opt/powerpc64le-linux-gnu/lib/gcc/powerpc64le-linux-gnu/7.1.0/include /opt/powerpc64le-linux-gnu/lib/gcc/powerpc64le-linux-gnu/7.1.0/include-fixed /opt/powerpc64le-linux-gnu/powerpc64le-linux-gnu/include /workspace/powerpc64le-linux-gnu-libgfortran4-cxx11/destdir/include /opt/powerpc64le-linux-gnu/powerpc64le-linux-gnu/sys-root/usr/include'
inews=''
initialinstalllocation='/workspace/destdir/bin'
installarchlib='.../../lib/perl5/5.34.1/linux-gnu'
...
installscript='.../'
installsitearch='.../../lib/perl5/site_perl/5.34.1/linux-gnu'
installsitebin='.../../bin'
installsitehtml1dir=''
installsitehtml3dir=''
...
lddlflags='-shared -L/workspace/destdir/lib --sysroot=/opt/powerpc64le-linux-gnu/powerpc64le-linux-gnu/sys-root -fstack-protector-strong'
...
libc='libc-2.17.so'
libperl='libperl.so'
libpth='/opt/powerpc64le-linux-gnu/powerpc64le-linux-gnu/lib /workspace/powerpc64le-linux-gnu-libgfortran4-cxx11/destdir/lib /opt/powerpc64le-linux-gnu/powerpc64le-linux-gnu/sys-root/usr/lib /opt/powerpc64le-linux-gnu/powerpc64le-linux-gnu/sys-root/lib64 /opt/powerpc64le-linux-gnu/powerpc64le-linux-gnu/sys-root/usr/lib64 /opt/powerpc64le-linux-gnu/powerpc64le-linux-gnu/sys-root/lib'
libs='-lpthread -ldl -lm -lutil -lc'
libsdirs=' /opt/powerpc64le-linux-gnu/powerpc64le-linux-gnu/sys-root/usr/lib64'
libsfiles=' libnsl.so'
libsfound=' /opt/powerpc64le-linux-gnu/powerpc64le-linux-gnu/sys-root/usr/lib64/libnsl.so'
libspath=' /opt/powerpc64le-linux-gnu/powerpc64le-linux-gnu/lib /workspace/powerpc64le-linux-gnu-libgfortran4-cxx11/destdir/lib /opt/powerpc64le-linux-gnu/powerpc64le-linux-gnu/sys-root/usr/lib /opt/powerpc64le-linux-gnu/powerpc64le-linux-gnu/sys-root/lib64 /opt/powerpc64le-linux-gnu/powerpc64le-linux-gnu/sys-root/usr/lib64 /opt/powerpc64le-linux-gnu/powerpc64le-linux-gnu/sys-root/lib'
libswanted='cl pthread socket inet nsl gdbm dbm db malloc dl ld sun m sec util c cposix posix ucb BSD gdbm_compat'
...
mydomain='.nonet'
myhostname='earth'
myuname='linux earth 5.15.3-gentoo #1 juliaos smp preempt wed feb 13 00:49:00 utc 2013 ppc64le gnulinux '
n='-n'
need_va_copy='undef'
...
phostname='hostname'
pidtype='pid_t'
plibpth='/opt/powerpc64le-linux-gnu/bin/../powerpc64le-linux-gnu/sys-root/lib/powerpc64le-linux-gnu/7.1.0 /opt/powerpc64le-linux-gnu/bin/../powerpc64le-linux-gnu/sys-root/lib/../lib64 /opt/powerpc64le-linux-gnu/bin/../powerpc64le-linux-gnu/sys-root/usr/lib/powerpc64le-linux-gnu/7.1.0 /opt/powerpc64le-linux-gnu/bin/../powerpc64le-linux-gnu/sys-root/usr/lib/../lib64 /opt/powerpc64le-linux-gnu/bin/../powerpc64le-linux-gnu/sys-root/lib /opt/powerpc64le-linux-gnu/bin/../powerpc64le-linux-gnu/sys-root/usr/lib'
pmake=''
pr=''
prefix='.../..'
prefixexp='.../..'
...
sig_size='69'
signal_t='void'
sitearch='.../../lib/perl5/site_perl/5.34.1/linux-gnu'
sitearchexp='.../../lib/perl5/site_perl/5.34.1/linux-gnu'
sitebin='.../../bin'
sitebinexp='.../../bin'
sitehtml1dir=''
sitehtml1direxp=''
...
sysroot='/opt/powerpc64le-linux-gnu/powerpc64le-linux-gnu/sys-root'
tail=''
tar=''
targetarch='powerpc64le-linux-gnu'
targetdir='/tmp'
targetenv=''
targethost='dummy'
...
tee=''
test='test'
timeincl='/opt/powerpc64le-linux-gnu/powerpc64le-linux-gnu/sys-root/usr/include/sys/time.h '
timetype='time_t'
tmpnam_r_proto='0'
...
usevfork='false'
usrinc='/opt/powerpc64le-linux-gnu/powerpc64le-linux-gnu/sys-root/usr/include'
uuname=''
uvXUformat='"lX"'
uvoformat='"lo"'
uvsize='8'
...
versiononly='undef'
vi=''
xlibpth=' /opt/powerpc64le-linux-gnu/powerpc64le-linux-gnu/sys-root/usr/lib/386 /opt/powerpc64le-linux-gnu/powerpc64le-linux-gnu/sys-root/lib/386'
yacc='yacc'
yaccflags=''
zcat=''
zip='zip'
