...
config_args='-des -Duserelocatableinc -Duseshrplib -Dusecrosscompile -Dsysroot=/opt/powerpc64le-linux-gnu/powerpc64le-linux-gnu/sys-root -Dtargethost=dummy -Dprefix=/workspace/destdir -Dhostperl=/workspace/srcdir/perl-5.34.0/host/miniperl -Dhostgenerate=/workspace/srcdir/perl-5.34.0/host/generate_uudmap -Dtargetrun=bb -Dtargetto=cp -Dccflags=-I/workspace/destdir/include -Dldflags=-L/workspace/destdir/lib -Dlddlflags=-shared -L/workspace/destdir/lib -Dtargetarch=powerpc64le-linux-gnu -Dlibs=-lpthread -ldl -lm -lutil -lc'
config_argc=16
config_arg1='-des'
...
config_arg8='-Dhostperl=/workspace/srcdir/perl-5.34.0/host/miniperl'
config_arg9='-Dhostgenerate=/workspace/srcdir/perl-5.34.0/host/generate_uudmap'
...
ar='ar'
archlib='.../../lib/perl5/5.34.0/linux-gnu'
archlibexp='.../../lib/perl5/5.34.0/linux-gnu'
archname64=''
archname='linux-gnu'
archobjs=''
asctime_r_proto='0'
...
ccdlflags='-Wl,-E -Wl,-rpath,\$$ORIGIN/../lib/perl5/5.34.0/linux-gnu/CORE'
...
installarchlib='.../../lib/perl5/5.34.0/linux-gnu'
...
installscript='.../'
installsitearch='.../../lib/perl5/site_perl/5.34.0/linux-gnu'
installsitebin='.../../bin'
installsitehtml1dir=''
installsitehtml3dir=''
...
rmail=''
run='/workspace/srcdir/perl-5.34.0/Cross/run-bb'
runnm='false'
...
sig_size='69'
signal_t='void'
sitearch='.../../lib/perl5/site_perl/5.34.0/linux-gnu'
sitearchexp='.../../lib/perl5/site_perl/5.34.0/linux-gnu'
sitebin='.../../bin'
sitebinexp='.../../bin'
sitehtml1dir=''
sitehtml1direxp=''
...
timetype='time_t'
tmpnam_r_proto='0'
to='/workspace/srcdir/perl-5.34.0/Cross/to-cp'
touch='touch'
tr='tr'
trnl='\n'
troff=''
