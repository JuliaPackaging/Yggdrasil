...
config_args='-des -Duserelocatableinc -Duseshrplib -Dusecrosscompile -Dsysroot=/opt/arm-linux-gnueabihf/arm-linux-gnueabihf/sys-root -Dtargethost=dummy -Dprefix=/workspace/destdir -Dhostperl=/workspace/srcdir/perl-5.34.0/host/miniperl -Dhostgenerate=/workspace/srcdir/perl-5.34.0/host/generate_uudmap -Dtargetrun=bb -Dtargetto=cp -Dccflags=-I/workspace/destdir/include -Dldflags=-L/workspace/destdir/lib -Wl,-rpath,/workspace/destdir/lib -Dlddlflags=-shared -L/workspace/destdir/lib -Wl,-rpath,/workspace/destdir/lib -Dtargetarch=arm-linux-gnueabihf -Dlibs=-lpthread -lcrypt -ldl -lm -lutil -lc'
config_argc=16
config_arg1='-des'
...
lddlflags='-shared -L/workspace/destdir/lib -Wl,-rpath,/workspace/destdir/lib --sysroot=/opt/arm-linux-gnueabihf/arm-linux-gnueabihf/sys-root -fstack-protector-strong'
