...
config_args='-des -Duserelocatableinc -Duseshrplib -Dusecrosscompile -Dsysroot=/opt/arm-linux-gnueabihf/arm-linux-gnueabihf/sys-root -Dtargethost=dummy -Dprefix=/workspace/destdir -Dhostperl=/workspace/srcdir/perl-5.34.0/host/miniperl -Dhostgenerate=/workspace/srcdir/perl-5.34.0/host/generate_uudmap -Dtargetrun=bb -Dtargetto=cp -Dccflags=-I/workspace/destdir/include -Dldflags=-L/workspace/destdir/lib -Dlddlflags=-shared -L/workspace/destdir/lib -Dtargetarch=arm-linux-gnueabihf -Dlibs=-lpthread -ldl -lm -lutil -lc'
config_argc=16
config_arg1='-des'
...
ar='ar'
archlib='.../../lib/perl5/5.34.0/linux-gnueabihf'
archlibexp='.../../lib/perl5/5.34.0/linux-gnueabihf'
archname64=''
...
ccdlflags='-Wl,-E -Wl,-rpath,\$$ORIGIN/../lib/perl5/5.34.0/linux-gnueabihf/CORE'
...
installarchlib='.../../lib/perl5/5.34.0/linux-gnueabihf'
...
installscript='.../'
installsitearch='.../../lib/perl5/site_perl/5.34.0/linux-gnueabihf'
installsitebin='.../../bin'
installsitehtml1dir=''
installsitehtml3dir=''
...
sig_size='69'
signal_t='void'
sitearch='.../../lib/perl5/site_perl/5.34.0/linux-gnueabihf'
sitearchexp='.../../lib/perl5/site_perl/5.34.0/linux-gnueabihf'
sitebin='.../../bin'
sitebinexp='.../../bin'
sitehtml1dir=''
sitehtml1direxp=''
