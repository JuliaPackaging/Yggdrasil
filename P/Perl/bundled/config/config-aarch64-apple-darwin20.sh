...
config_args='-des -Dcc=cc -Dprefix=/workspace/destdir -Duserelocatableinc -Dprocselfexe -Duseshrplib -Dsysroot=/opt/aarch64-apple-darwin20/aarch64-apple-darwin20/sys-root -Dccflags=-DPERL_FPU_INIT -fno-strict-aliasing -pipe -fstack-protector-strong -I/workspace/destdir/include -Dldflags=-L/workspace/destdir/lib -Dlddlflags=-dynamiclib -undefined dynamic_lookup -L/workspace/destdir/lib -Dusecrosscompile -Dtargethost=localhost -Dtargetarch=aarch64-darwin -Dhostperl=/workspace/srcdir/perl-5.34.0/host/miniperl -Dhostgenerate=/workspace/srcdir/perl-5.34.0/host/generate_uudmap -Dtargetuser=username -Dtargetdir=/Users/username/tmpdir -Dtargetport=2222 -Dusenm=false -Dlibs=-lpthread -ldbm -ldl -lm -lutil -lc'
config_argc=20
config_arg1='-des'
config_arg2='-Dcc=cc'
...
config_arg14='-Dhostperl=/workspace/srcdir/perl-5.34.0/host/miniperl'
config_arg15='-Dhostgenerate=/workspace/srcdir/perl-5.34.0/host/generate_uudmap'
...
ar='ar'
archlib='.../../lib/perl5/5.34.0/darwin-2level'
archlibexp='.../../lib/perl5/5.34.0/darwin-2level'
archname64=''
...
installarchlib='.../../lib/perl5/5.34.0/darwin-2level'
...
installscript='.../'
installsitearch='.../../lib/perl5/site_perl/5.34.0/darwin-2level'
installsitebin='.../../bin'
installsitehtml1dir=''
installsitehtml3dir=''
...
shmattype='void *'
shortsize='2'
shrpenv='env LD_RUN_PATH=/workspace/destdir/lib/perl5/5.34.0/darwin-2level/CORE'
shsharp='true'
sig_count='32'
...
sig_size='33'
signal_t='void'
sitearch='.../../lib/perl5/site_perl/5.34.0/darwin-2level'
sitearchexp='.../../lib/perl5/site_perl/5.34.0/darwin-2level'
sitebin='.../../bin'
sitebinexp='.../../bin'
sitehtml1dir=''
sitehtml1direxp=''
