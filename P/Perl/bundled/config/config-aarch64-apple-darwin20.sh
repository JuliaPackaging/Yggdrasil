...
config_args='-des -Dcc=cc -Dprefix=/workspace/destdir -Duserelocatableinc -Dprocselfexe -Duseshrplib -Dsysroot=/opt/aarch64-apple-darwin20/aarch64-apple-darwin20/sys-root -Dccflags=-DPERL_FPU_INIT -fno-strict-aliasing -pipe -fstack-protector-strong -I/workspace/destdir/include -Dldflags=-L/workspace/destdir/lib -Wl,-rpath,/workspace/destdir/lib -Dlddlflags=-dynamiclib -undefined dynamic_lookup -L/workspace/destdir/lib -Wl,-rpath,/workspace/destdir/lib -Dusecrosscompile -Dtargethost=localhost -Dtargetarch=aarch64-darwin -Dhostperl=/workspace/srcdir/perl-5.34.0/host/miniperl -Dhostgenerate=/workspace/srcdir/perl-5.34.0/host/generate_uudmap -Dtargetuser=username -Dtargetdir=/Users/username/tmpdir -Dtargetport=2222 -Dusenm=false -Dlibs=-lpthread -ldbm -ldl -lm -lutil -lc'
config_argc=20
config_arg1='-des'
config_arg2='-Dcc=cc'
...
config_arg9='-Dldflags=-L/workspace/destdir/lib -Wl,-rpath,/workspace/destdir/lib'
config_arg10='-Dlddlflags=-dynamiclib -undefined dynamic_lookup -L/workspace/destdir/lib -Wl,-rpath,/workspace/destdir/lib'
...
ld='cc'
ld_can_script='undef'
lddlflags=' -mmacosx-version-min=10.8 -dynamiclib -undefined dynamic_lookup -fstack-protector-strong -L/workspace/destdir/lib -Wl,-rpath,/workspace/destdir/lib --sysroot=/opt/aarch64-apple-darwin20/aarch64-apple-darwin20/sys-root'
