...
config_args='-des -Duserelocatableinc -Duseshrplib -Dusecrosscompile -Dsysroot=/opt/arm-linux-musleabihf/arm-linux-musleabihf/sys-root -Dtargethost=dummy -Dprefix=/workspace/destdir -Dhostperl=/workspace/srcdir/perl-5.34.0/host/miniperl -Dhostgenerate=/workspace/srcdir/perl-5.34.0/host/generate_uudmap -Dtargetrun=bb -Dtargetto=cp -Dccflags=-I/workspace/destdir/include -Dldflags=-L/workspace/destdir/lib -Dlddlflags=-shared -L/workspace/destdir/lib -Dtargetarch=arm-linux-musleabihf -Dlibs=-lpthread -lcrypt -ldl -lm -lutil -lc'
config_argc=16
config_arg1='-des'
...
ar='ar'
archlib='.../../lib/perl5/5.34.0/linux-musleabihf'
archlibexp='.../../lib/perl5/5.34.0/linux-musleabihf'
archname64=''
...
ccdlflags='-Wl,-E -Wl,-rpath,\$$ORIGIN/../lib/perl5/5.34.0/linux-musleabihf/CORE'
...
installarchlib='.../../lib/perl5/5.34.0/linux-musleabihf'
...
installscript='.../'
installsitearch='.../../lib/perl5/site_perl/5.34.0/linux-musleabihf'
installsitebin='.../../bin'
installsitehtml1dir=''
installsitehtml3dir=''
...
sig_size='68'
signal_t='void'
sitearch='.../../lib/perl5/site_perl/5.34.0/linux-musleabihf'
sitearchexp='.../../lib/perl5/site_perl/5.34.0/linux-musleabihf'
sitebin='.../../bin'
sitebinexp='.../../bin'
sitehtml1dir=''
sitehtml1direxp=''
