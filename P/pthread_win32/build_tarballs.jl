...
sources = [
    GitSource("https://github.com/GerHobbelt/pthread-win32.git",
              "512a38decec4d2007d4b336f5f24f7e4afa23bd0")
]
...
products = Product[
    LibraryProduct("pthreadGC3", :pthread)
]
