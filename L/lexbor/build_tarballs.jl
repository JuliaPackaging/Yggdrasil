...
cmake -B build -G "Unix Makefiles" -DCMAKE_INSTALL_PREFIX=$prefix -DCMAKE_TOOLCHAIN_FILE=${CMAKE_TARGET_TOOLCHAIN} -DCMAKE_BUILD_TYPE=Release -DLEXBOR_BUILD_SEPARATELY=ON -DLEXBOR_BUILD_STATIC=OFF
