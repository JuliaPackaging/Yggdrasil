...
cd build
ls
cmake -DCMAKE_INSTALL_PREFIX=$prefix -DCMAKE_TOOLCHAIN_FILE=${CMAKE_TARGET_TOOLCHAIN} -DCMAKE_BUILD_TYPE=Release -DBUILD_SHARED_LIBS=ON -DBUILD_GMOCK=OFF -DLEVELDB_BUILD_TESTS=OFF LEVELDB_BUILD_BENCHMARKS=OFF ..
cmake --build .
make 
make install
"""
