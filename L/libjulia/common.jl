...
julia_full_versions = [#=v"1.6.3", v"1.7.0", v"1.8.2",=# v"1.9.0", v"1.10.0", v"1.11.1", v"1.12.0", v"1.13.0"]
...
function build_julia(ARGS, version::VersionNumber; jllversion=version)
    ...
    checksums = Dict(
        ...
        v"1.12.0" => "2dba42b3f143564f96c60948d1100db0902aa3cb98ebf89c156b4091f05d9b89",
    )
