...
function build_julia(ARGS, version::VersionNumber; jllversion=version)
    ...
    checksums = Dict(
        ...
        v"1.9.0-rc2" => "ba282663486bcd13562532ff1049a95aed16f8086f7c63ed09779fa3362b0a35",
    )

    if version == v"1.10.0-DEV"
        sources = [
            GitSource("https://github.com/JuliaLang/julia.git", "f84fb5b26f87169c00e4bdc3c4db050772974023"),
