...
sources = [
    ArchiveSource("https://github.com/libgd/libgd/releases/download/gd-2.3.0/libgd-2.3.0.tar.gz")
]
...
dependencies = [
    Dependency(PackageSpec(name="JpegTurbo_jll", "aacddb02-875f-59d6-b918-886e6ef4fbf8")),
