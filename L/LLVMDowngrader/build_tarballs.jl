...
sources = Dict(
    ...
    v"15.0.7" => [GitSource(repo, "9af5f3e6ee66f617ba2f3339dba88a0dfab66c65")],
    v"16.0.6" => [GitSource(repo, "a5acfa5983ef6ca771549fea93950dda1a87c2c7")],
    v"17.0.6" => [GitSource(repo, "b73c85b3dd799b9c904c7565359cf3741496836e")],
)
