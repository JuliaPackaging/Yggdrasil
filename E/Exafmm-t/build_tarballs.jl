...
sources = [
    GitSource("https://github.com/JoshuaTetzner/exafmm-t.git", "e0a28e2d57c2ca371ec0fa3200fa197fe0265324")
]
...
products = [
    LibraryProduct("libExaFMMCInterface", :exafmmt)
    LibraryProduct("libExaFMMCInterface32", :exafmmt32)
]
