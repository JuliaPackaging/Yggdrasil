...
sources = [
    GitSource("https://github.com/awslabs/aws-c-io.git", "ba5cb6de2cf12bfb154f302f6dedddf81c0ce4cd"),
...
dependencies = [
    Dependency("s2n_tls_jll"; compat="1.5.24", platforms=filter(p->Sys.islinux(p) || Sys.isfreebsd(p), platforms)),
