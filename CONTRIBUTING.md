...
* the problematic dependendency _**does not have**_ a compat bound yet: in this case you may open a new PR to Yggdrasil to _add_ an appropriate compat bound for the package in question;
