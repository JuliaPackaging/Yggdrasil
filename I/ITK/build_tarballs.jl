...
cmake -B build \
    ...
    -DITK_USE_SYSTEM_TBB:BOOL=ON \
    -DQNANHIBIT_VALUE:BOOL=0 \
    -DQNANHIBIT_VALUE__TRYRUN_OUTPUT:STRING=0 \
    -DRUN_RESULT_VAR:STRING=0 \
    -DRUN_RESULT_VAR__TRYRUN_OUTPUT:STRING=0 \
    -DH5_LDOUBLE_TO_LONG_SPECIAL_RUN:STRING=0 \
    -DH5_LDOUBLE_TO_LONG_SPECIAL_RUN__TRYRUN_OUTPUT:STRING=0 \
    -DH5_LONG_TO_LDOUBLE_SPECIAL_RUN:STRING=0 \
    -DH5_LONG_TO_LDOUBLE_SPECIAL_RUN__TRYRUN_OUTPUT:STRING=0 \
    -DH5_LDOUBLE_TO_LLONG_ACCURATE_RUN:STRING=0 \
    -DH5_LDOUBLE_TO_LLONG_ACCURATE_RUN__TRYRUN_OUTPUT:STRING=0 \
    -DH5_LLONG_TO_LDOUBLE_CORRECT_RUN:STRING=0 \
    -DH5_LLONG_TO_LDOUBLE_CORRECT_RUN__TRYRUN_OUTPUT:STRING=0 \
    -DH5_DISABLE_SOME_LDOUBLE_CONV_RUN:STRING=0 \
    -DH5_DISABLE_SOME_LDOUBLE_CONV_RUN__TRYRUN_OUTPUT:STRING=0 \
    -DH5_NO_ALIGNMENT_RESTRICTIONS_RUN:STRING=0 \
    ...
    -DVXL_HAS_SSE2_HARDWARE_SUPPORT__TRYRUN_OUTPUT:STRING=0 \
    -DVXL_SSE2_HARDWARE_SUPPORT_POSSIBLE:STRING=1 \
    -DVXL_SSE2_HARDWARE_SUPPORT_POSSIBLE__TRYRUN_OUTPUT:STRING=0 \
    -DVCL_HAS_LFS:STRING=1 \
    -DVCL_HAS_LFS__TRYRUN_OUTPUT:STRING=0 \
    -DDOUBLE_CONVERSION_CORRECT_DOUBLE_OPERATIONS:STRING=1 \
    -DDOUBLE_CONVERSION_CORRECT_DOUBLE_OPERATIONS__TRYRUN_OUTPUT:STRING=0 \
    -D_libcxx_run_result:STRING=0 \
    -D_libcxx_run_result__TRYRUN_OUTPUT:STRING="success" \
