...
mkdir -p $bindir
gfortran -O3 -o $exe_out src/constants.o src/globaldata.o src/functions.o src/io.o src/structure.o src/pes.o src/rpath.o src/pathopt.o src/pathfinder.o src/main.o -L"${libdir}" -lopenblas
"""
