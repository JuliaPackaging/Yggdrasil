dependencies = [BuildDependency(PackageSpec(name="CUDA_full_jll", version=v"11.5.0"))]
...
products = [
    ...
    LibraryProduct(["libcupti", "cupti64_2021.3.0"], :libcupti),
...
platforms = [Platform("x86_64", "linux"; cuda="11.4"),
             ...
             Platform("aarch64", "linux"; cuda="11.4"),
