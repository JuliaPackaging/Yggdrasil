...
products = [
    ...
    ExecutableProduct("chicken-do", :chicken),
    ExecutableProduct("chicken-install", :chicken),
    ExecutableProduct("chicken-profile", :chicken),
    ExecutableProduct("chicken-status", :chicken),
    ExecutableProduct("chicken-uninstall", :chicken),
    ExecutableProduct("csc", :csc),
    ExecutableProduct("csi", :csi),
