...
cp .emscripten ${prefix}/lib/emscripten
EMSCRIPTEN=/opt/${target}/lib/emscripten
cp ${prefix}/lib/emscripten/cmake/Modules/Platform/Emscripten.cmake ${prefix}/wasm32-unknown-emscripten.toolchain
...
config = ""
name = "Emscripten-wasm32-unknown-emscripten"
